...
dataZapata = [
                    top10DefendingDuelSuccessRate[8],
                    top10AirDuelSuccessRate[8],
                    top10Intercept[8],
                    top10SmartPassSuccessRate[8],
                    top10RedCardsPerGame[8]
                ]
...
clubColors = ["#CE171F", "#231F20", "white"]
makeComparisonRadar(clubColors, "Zapata", dataZapata, dataLeague)
